...
S =expand_grid( [3000],           #Population Size
                [12],             #ngroups
                [[4, 3]],        #lattice, will be replaced below
                [0],             #travel cost
                [1],             #tech
                [.9],            #labor
...
(collect(range(-4, stop = 1, length = 20))).^10
...
@JLD2.save("abm_dat_effort_hm_leak12.jld2", abm_dat, S)
...
@JLD2.save("abm_dat_effort_hm_leakp112.jld2", abm_dat, S)
...
@JLD2.save("abm_dat_effort_hm_leakp1p212.jld2", abm_dat, S)
