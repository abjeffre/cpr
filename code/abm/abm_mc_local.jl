...
@everywhere function g(n, ng, l, v, dg, df, el, ep, eg, c, sl, lk, sp, mf)
    cpr_abm(n = n,
            nrounds = 2000,
            nsim = 30,
            ngroups = ng,
...
@JLD2.save("abm_dat_econWS.jld2", abm_dat, S)
@JLD2.save("abm_dat_econ.jld2", abm_dat)
