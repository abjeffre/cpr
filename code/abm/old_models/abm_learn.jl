...
#############################################################################
    ...
    elseif year == 2
        ...
        effort[:,1] = 1 .- ne
    elseif year > 2
        effort=RWLearn(agents, effort, memory, αlearn)
    end
    ...
    memory[:payoff_round] = agents.payoff_round
    ...
    if year > 1
        ...
        models=GetModelsn3(agents, history, learn_type, year)
