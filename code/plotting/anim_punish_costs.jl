...
@JLD2.load("cpr//data//abm//leak_pun1.jld2")
...
anim = @animate for i = 1:10
#Define line settings
ps1 = [p_arr[i, 1, 1] p_arr[i, 1, 1] p_arr[i, 1, 1]]
ps2 = [p_arr[i, 1, 2] p_arr[i, 1, 2] p_arr[i, 1, 2]]
...
ps1 = [p_arr[1, 1, 1] p_arr[5, 1, 1] p_arr[10, 1, 1]]
ps2 = [p_arr[1, 1, 2] p_arr[5, 1, 2] p_arr[10, 1, 2]]
...
gif(anim, string("C:\\Users\\jeffr\\Documents\\work\\cpr\\output\\pred_pc1_catch_after.gif")
, fps = fps)
...
gif(anim, string("C:\\Users\\jeffr\\Documents\\work\\cpr\\output\\pred_p1base_high.gif")
, fps = fps)
...
gif(anim, string("C:\\Users\\jeffr\\Documents\\work\\cpr\\output\\pred_p1base_low.gif")
, fps = fps)
