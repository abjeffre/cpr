...
using JLD2
using Plots
@JLD2.load("C:\\Users\\jeffr\\Documents\\work\\cpr\\data\\abm\\abm_dat_effort_hm_full.jld2")
...
plot(set1, set2, set3, set4, set5, test, size = (500, 1500), left_margin = 20px, bottom_margin = 20px, right_margin = 10px,
 layout = l)
end
