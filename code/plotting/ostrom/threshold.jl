# using Plots.PlotMeasures
 ...
 for i in 0.5:.5:10
     c = cpr_abm(degrade = 1, n=50*ngroups, ngroups = ngroups, lattice = [1,2],
         max_forest = 50000*ngroups, tech = .00002, wages = 1, price = 3, nrounds = 1500, leak = false,
 ...
 vline!([.334, .334], title = "(l)", titlelocation = :left, titlefontsize = 15, grid = false, label = "MSY")
 plot(out[i][:stock][:,1,1])