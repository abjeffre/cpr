...
plot(set1, set2, set3, size = (1000, 666), left_margin = 20px, bottom_margin = 20px, right_margin = 10px,
 layout = (3,1))
end
gif(anim, string("C:\\Users\\jeffr\\Documents\\work\\cpr\\output\\pred_pc2.gif")
, fps = fps)
