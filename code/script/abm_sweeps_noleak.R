...
sweep_noleak <- list(par = sweeps,
                   data = cpr_sweeps)

saveRDS(sweep_noleak, file = paste0(path$dataAbm, "cpr_sweeps_noleak.RDS"))
...
sweep_noleak2 <- list(par = sweeps2,
                     data = cpr_sweeps2)

saveRDS(sweep_noleak2, file = paste0(path$dataAbm, "cpr_sweeps_noleak2.RDS"))
...
sweep_noleak3 <- list(par = sweeps3,
                      data = cpr_sweeps3)
...
sweep_noleak5 <- list(par = sweeps5,
                      data = cpr_sweeps5)

saveRDS(sweep_noleak5, file = paste0(path$dataAbm, "cpr_sweeps_noleak5.RDS"))
